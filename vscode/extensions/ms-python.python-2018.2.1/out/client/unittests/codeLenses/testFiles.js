            ...
            case vscode_1.SymbolKind.Class: {
                ...
                return [
                    new vscode_1.CodeLens(range, {
                        ...
                        arguments: [constants_1.CommandSource.codelens, file, { testSuite: [cls] }]
                    }),
                    new vscode_1.CodeLens(range, {
...
function getFunctionCodeLens(file, functionsAndSuites, symbolName, range, symbolContainer) {
    ...
    if (fn) {
        return [
            new vscode_1.CodeLens(range, {
                ...
                command: constants.Commands.Tests_Run,
                arguments: [constants_1.CommandSource.codelens, file, { testFunction: [fn] }]
            }),
            new vscode_1.CodeLens(range, {
    ...
    if (functions.length === 0) {
        return [
            new vscode_1.CodeLens(range, {
                ...
                command: constants.Commands.Tests_Run,
                arguments: [constants_1.CommandSource.codelens, file, { testFunction: functions }]
            }),
            new vscode_1.CodeLens(range, {
    ...
    return [
        new vscode_1.CodeLens(range, {
            ...
            arguments: [constants_1.CommandSource.codelens, file, functions]
        }),
        new vscode_1.CodeLens(range, {
