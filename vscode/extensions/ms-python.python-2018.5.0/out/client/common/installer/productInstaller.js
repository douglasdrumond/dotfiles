...
class BaseInstaller {
    constructor(serviceContainer, outputChannel) {
        ...
        this.workspaceService = serviceContainer.get(types_5.IWorkspaceService);
    }
    ...
    isInstalled(product, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isModule) {
                ...
                const process = yield this.serviceContainer.get(types_7.IProcessServiceFactory).create(resource);
    ...
    install(product, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.serviceContainer.get(types_6.IPlatformService).isWindows) {
                ...
                const terminalService = this.serviceContainer.get(types_8.ITerminalServiceFactory).getTerminalService(resource);
                const logger = this.serviceContainer.get(types_9.ILogger);
...
class FormatterInstaller extends BaseInstaller {
    promptToInstallImplementation(product, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // another formatter.
            const formatters = [types_9.Product.autopep8, types_9.Product.black, types_9.Product.yapf];
            ...
            const yesChoice = 'Yes';
            const item = yield this.appShell.showErrorMessage(`Formatter ${productName} is not installed. Install?`, yesChoice, ...useOptions);
            if (item === yesChoice) {
...
let ProductInstaller = class ProductInstaller {
    constructor(serviceContainer, outputChannel) {
        ...
        this.ProductTypes.set(types_9.Product.black, ProductType.Formatter);
...
function translateProductToModule(product, purpose) {
    switch (product) {
        ...
        case types_9.Product.black: return 'black';
