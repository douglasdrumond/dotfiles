        ...
        return new Promise((resolve, reject) => {
            const req = https.request(options, (resp) => {
                ...
                if (resp.statusCode < 200 || resp.statusCode > 300) {
                    utils_1.log(`Failed to send analytics ${resp.statusCode}: ${resp.statusMessage}`);
                }
                resolve();
            });
