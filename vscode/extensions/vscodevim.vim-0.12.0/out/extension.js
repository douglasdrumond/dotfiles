...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        extensionContext.subscriptions.push(logger_1.Logger);
        ...
        commandLine_1.CommandLine.LoadHistory();
...
process.on('unhandledRejection', function (reason, p) {
    logger_1.Logger.debug(`Unhandled Rejection at: Promise ${p}. Reason: ${reason}.`);
});
