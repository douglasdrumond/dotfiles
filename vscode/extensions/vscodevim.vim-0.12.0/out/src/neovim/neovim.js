...
class Neovim {
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.process.on('error', err => {
                logger_1.Logger.error(err.message, `Neovim: Error spawning neovim. Error=${err.message}.`);
    ...
    syncVimToVs(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.Logger.debug(`Neovim: ${lines.length} lines in nvim but ${textEditor_1.TextEditor.getLineCount()} in editor.`);
