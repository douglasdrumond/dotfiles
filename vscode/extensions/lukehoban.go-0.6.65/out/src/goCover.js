...
function highlightCoverage(editor, file, remove) {
    ...
    if (coverageDecorator === 'gutter') {
        editor.setDecorations(exports.coveredGutter, hideCovered ? [] : file.coveredRange);
        editor.setDecorations(exports.uncoveredGutter, hideUncovered ? [] : file.uncoveredRange);
    }
    else {
